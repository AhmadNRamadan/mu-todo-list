                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'Title',
                        floatingLabelStyle: TextStyle(color: HColor.secondary),
                        prefixIcon: Icon(Icons.title, color: HColor.primary),
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      decoration: InputDecoration(
                        labelText: 'Category *',
                        floatingLabelStyle: TextStyle(color: HColor.secondary),
                        prefixIcon: Icon(Icons.category, color: HColor.primary),
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(12),
                        ),
                        focusedBorder: OutlineInputBorder(
